    ...
    for (var j = 0; j < keys.length; j++) {
      ...
      try 
      {
        ...
        for (var i = 1; i < values.length; i++) {
          ...
          {
            var thenFunction = function(signup_button, key) {
              return function() {
                ...
                this.waitFor(check, retrieveDescription(signup_button, key), 10000);
          
              };
            };

            this.then(thenFunction(classInfo['signup_button'], key));
          }
