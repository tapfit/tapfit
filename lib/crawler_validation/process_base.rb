...
class ProcessBase
  ...
  attr_accessor :name, :address, :tags, :url, :photo_url, :phone_number, :source_description, :source, :source_id, :start_time, :end_time, :price, :instructor, :place_id, :dropin_price, :schedule_url, :category, :can_buy, :is_day_pass, :is_cancelled, :facility_type, :crawler_source
