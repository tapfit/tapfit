...
class ProcessBase
  ...
  attr_accessor :name, :address, :tags, :url, :photo_url, :phone_number, :source_description, :source, :source_id, :start_time, :end_time, :price, :instructor, :place_id, :dropin_price, :schedule_url, :category, :can_buy, :can_buy_class, :is_day_pass
