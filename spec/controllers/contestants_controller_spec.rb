  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contestant as @contestant" do
        ...
        post :create, {:contestant => { "email" => "invalid value" }}, valid_session
        assigns(:contestant).should be_a_new(Contestant)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contestant" do
        ...
        Contestant.any_instance.should_receive(:update).with({ "email" => "MyString" })
        put :update, {:id => contestant.to_param, :contestant => { "email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contestant as @contestant" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contestant.any_instance.stub(:save).and_return(false)
        put :update, {:id => contestant.to_param, :contestant => { "email" => "invalid value" }}, valid_session
        assigns(:contestant).should eq(contestant)
      end
